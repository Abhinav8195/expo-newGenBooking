          ...
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 16 }}>
              <View style={{ flex: 1, marginRight: 10 }}>
                <Text style={styles.label}>Pick-up Destination</Text>
                <TextInput
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 }}>
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Text style={{ color: date ? '#222' : '#a0a0a0' }}>{formatDate(date)}</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.input, styles.halfInput, styles.picker]}
                ...
                activeOpacity={0.7}
              >
                <Text style={{ color: time ? '#222' : '#a0a0a0' }}>{formatTime(time)}</Text>
              </TouchableOpacity>
            </View>
